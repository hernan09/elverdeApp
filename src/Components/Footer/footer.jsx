...
const Footer = () => {
  ...
  return (
    <div className="content-footer">
        <a className="footer-link" rel="noopener noreferrer" target="_blank" href="https://github.com/hernan09/">
          © Powered by Hernán
        </a>
      <span className="content-icons">
        <a rel="noopener noreferrer" onClick={eventClick} target="_blank" href="https://www.linkedin.com/in/hern%C3%A1n-gomez/">
          <img className="icon-footer" src={LinkediIcon} alt="LinkedIn" />
        </a>
        <a rel="noopener noreferrer" onClick={eventClick} target="_blank" href="https://github.com/hernan09/">
          <img className="icon-footer git" src={GitIcon} alt="GitHub" />
        </a>
      </span>
    </div>
  );
